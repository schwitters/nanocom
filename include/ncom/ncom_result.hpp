...
/**
 * @file ncom_result.hpp
 * @brief C++ result type wrapping ncom_status_t + value (optional).
 *
...
#ifndef NCOM_NCOM_RESULT_HPP
#define NCOM_NCOM_RESULT_HPP
